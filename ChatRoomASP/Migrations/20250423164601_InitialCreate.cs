    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRelation", x => x.UserRelationId);
                    table.ForeignKey(
                        name: "FK_UserRelation_IMUsers_InitiatorUserId",
                        column: x => x.InitiatorUserId,
                        principalTable: "IMUsers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRelation_IMUsers_TargetUserId",
                        column: x => x.TargetUserId,
                        principalTable: "IMUsers",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRelation_RelationTypes_RelationTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileSize = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRelation_InitiatorUserId",
                table: "UserRelation",
                column: "InitiatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRelation_RelationTypeId",
                table: "UserRelation",
