...
{
    /// <inheritdoc />
    public partial class MigrateAspNetUsersToUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // 修改所有DROP TABLE语句为IF EXISTS形式
            ...
            // 新增数据迁移SQL
            migrationBuilder.Sql("INSERT INTO Users (UserName, Email, PasswordHash) SELECT UserName, Email, PasswordHash FROM AspNetUsers");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRelations_UserId1_UserId2_RelationTypeId",
                table: "UserRelations",
                columns: new[] { "UserId1", "UserId2", "RelationTypeId" },
                unique: true);
